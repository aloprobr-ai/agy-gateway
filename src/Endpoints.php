...
final class Endpoints
{
    ...
    private static function chatViaCli(array $cfg, array $req, string $keyLabel): void
    {
        ...
        // Битые буквы от CLI (U+FFFD на стыке дельт) AgyClient уже чинит сам,
        // досылая хвост из поля response. Если поток всё же разошёлся с полным
        // ответом, отдаём его отдельным полем, чтобы клиент заменил накопленное.
        // Чужие клиенты незнакомое поле просто игнорируют.
